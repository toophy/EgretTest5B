...
namespace xgame {
    ...
    // 获取当前运行中账号
    export function GetMainAccount():AccountEnv{
        return GetMain().GetCurrent();
    }

    // 帐号管理器
    export class Main {
        public static instance: Main = null;
        public accountEnvs: MapStr<AccountEnv> = new MapStr<AccountEnv>();
        public currAccountEnv: AccountEnv = null;
        private tmpAccountEnv: AccountEnv = null;
        ...
        public MakeTmpAccountEnv(): void {
            ...
            this.tmpAccountEnv = new AccountEnv(this.rootDisplay);
